                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>${o.price} Ngàn Đồng</td>
                                <td>${o.quantity}</td>
                                <td>
                                    <a href="loadProduct?pid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Sửa">&#xE254;</i></a>
                                    <a href="delete?pid=${o.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Xóa">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <div class="modal-content">
                    <form action="delete" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <input type="hidden" name="pid" id="deleteProductId">
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Hủy">
